...
public class ArrayExample1 {
	...
	public static void main(String[] args) {
	    ...
	    //배열의 길이 알아오기
	    //배열.length :배열의 길이 값이 저장되어 잇음.
	    System.err.println("win[]의 길이 : "+ win.length);
	    System.err.println("welcome[]의 길이 : "+ welcome.length);
	    
	    //배열과 반복문
	    for (int i = 0; i< win.length; i++) {
	    	if(win[i]) {System.out.println(i+1+"번재 전적 :승리");
	    	}else {
	    		System.out.println(i+1+"번재 전적 :패배");
	    	}
	    }
		
		//배열의 내용 출력
	    //Arrays. toString()를 통해서 배열 내용을 출력
	    //Array.toString()를 통해서 배열 내용을 출력
