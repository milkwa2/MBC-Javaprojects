...
public class ArrayExample2 {
	...
	public static void main(String[] args) {
		...
		// n차원 배열의 모든 요소를 n 중 반복문을 통해서 탐색이 가능함
		// 2차 배열의 요소 출력 
		...
		// 향상된 for문
		// 배열과 Collection 같이 연속된 자료 타입을 출력하기 위한 for묹
		// 카운트 변수와 증감식을 사용하지 않고, 항목의 개수만큼 반복한 후에 자동으로 for문을 빠져나감
		// for (타입 변수 : 배열(앞에 타입 배열){
		//     반복 실행문
		// }
