...
public class CustomManager2 {
    //Customer 라는 클래스를 불러와서 고객 정보를 저장하는 객체로 삼고 동작하는 고객관리 프로그램.
	...
	//기존에 사용했던 index는 사용 안해도 됨... 객체 내의 고유 정보를 통한 검색을 이용할 예정.
	
	//count 는 사용 .. 저장한 데이터의 크기.
	static int count;
...
//        System.out.println("Customer 객체의 이름 : " + cus.getName());
	...
	public static void insertCustomerData() {
		...
		Customer c1 =new Customer(name, gender, email, birth);
		cusList[count]= c1;
		count ++;
	...
	public static Customer selectCustomerData() {
		while(true) {
			System.out.print("출력, 수정 또는 삭제할 사람의 이름을 입력해 주세요  ");
			String name = scan.next();
