...
public class ClientExample1 {
   ...
   public static void main(String[] args) {
      try {
         // 1. Socket 생성
         // -방법1 생성자에 직업 입력하는 방법
         //Socket socket = new Socket("192.168.0.143", 50001);
         // -방법2 생성자 주입 정보 : InetSocketAddress 객체 사용
    	  Socket socket = new Socket();
    	  InetSocketAddress serverAddr = new InetSocketAddress("192.168.0.143", 50001);
      ...
      // 전송 데이터 받기
         ...
         int readByteCount = is.read(bytes1);
         String message = new String(bytes1,0,readByteCount,"UTF-8");
