...
public class OperaterEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("++ 전치 처리 결과 : "+ (++a)); //11
		System.out.println("-- 전치 처리 결과 : "+ (--a)); //10
        System.out.println(a);
        // 후치 처리 결과
        System.out.println("++ 후치 결과 : "+ a++);      //10 출력,a값 1증감
        System.out.println(a);
        System.out.println("-- 후치 결과 : "+ a--);      //11 출력,a값 1감소
        ...
        // 사용되는 곳이 배수관계, 난수 계산
        // 제곱
        System.out.println((int)Math.pow(x, 3)); //x위치에 값, 3은 3승 1000
       ...
       //좌측은 정수, 우측 피연산자가 0인경우. ArithmeticException 발생
       // 5/0.0 =>무한대
       // 5%0.0 =>NaN
       // 이 두가지의 경우에 연산은 수행하면 안됨
     ...
     //비교 연산자
      ...
      //문자열 비교시 equals() 또는 !equlas()를 ==, != 연산자 대신 사용
