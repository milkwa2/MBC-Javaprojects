...
public class InheritanceEx1 {
	 ...
	 *   - 클래스의 상속은 단일 상속만 가능함.
	 *     단, 인터페이스는 다중 상속이 가능함.
	 *   - 상속은 extends라는 키워드를사용하여 상속을 표현함.
	 *   - 어떤 클래스가 다른 클래스로부터 상속을 받아 만들어지면 새롭게 만들어진 클래스를 
	 *     자식 클래스(child or sub)라고 부르면, 멤버변수와 메서드를 클래스를 
	 *     부모 클래스(parent or super)라고 합니다. 
	 *   - 상속을 하게 되면 부모 클래스의 멤버 변수(필드)와 메서드를 자식 클래스에 상속하게
	 *     됩니다. 하지만, 생성자는 상속되지 않습니다.
	 ...
	 *     - 잘못 사용한 경우 : 개별 클래스들이 중복된 속성(멤버변수,필드)/기능(메서드)을 포함 
	...
	public static void main(String[] args) {
        ...
        System.out.println(t1); // overrid안함 : ch7.obj.Teacher@5427c60c
		...
		s3.height = 180;
		System.out.println("s3 - 이율, 15의 해쉬값 : " + s3.hashCode());
