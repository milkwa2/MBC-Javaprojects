...
public class PolymorphisEx2 {

   public static void main(String[] args) {
	   
	   // instanceof
	   // - 자바 키워드 중 하나로 instanceof는 객체가 지정한 클래스 인지 아닌지 검사할 때 사용
...
//      System.out.println("instanceof 결과 : "+ (s instance of Student));
      printPersonInfo(s);
   ...
   public static void printPersonInfo(Person p) {
	   ...
	   /*
	    *  student인 경우 배너는 student info로, teacher인 경우 teacher innfo
