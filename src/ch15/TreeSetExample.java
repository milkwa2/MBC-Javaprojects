...
public class TreeSetExample {
	...
	public static void main(String[] args) {
		...
		// tailSet(n) : n부터 꼬리쪽(오른쪽)에 있는 요소를 Set 으로반환
		System.out.println(tree.tailSet(9));
		
		// subSet(start,end):start이상, end미만의 요소 Set 으로 반환
		...
		//pollFrist 첫번째 요소를 반환하면서 지움
//		 System.out.println(tree.pollFirst()); // 1반환 [7,9,10,15,17,21]
//		 System.out.println(tree.pollFirst()); // 1반환 [9,10,15,17,21]
//		 System.out.println(tree.pollFirst()); // 1반환 [10,15,17,21]
//		 System.out.println(tree);
//		
