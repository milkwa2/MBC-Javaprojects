...
public class SetExample {
	...
	/*
	 *  Set - 집합을 구현해 놓은 컬렉션. 중복 값을 저장하지 않습니다.
	 * 
	 *  주요 메서드 
	 *   - add() : 값을 추가. 반환타입은 true(성공) or false(중복)
	...
	public static void main(String[] args) {
		...
		Object[] char_arr = list.toArray();   // toArray를 list를 배열
		...
		Iterator iterator = set.iterator(); // 타입의 Object로 되어 잇음.
