 ...
 *     이유? 변수명에서는 " "를 사용하면 안됨.
 *     ex) int plus result (x) -> int pluaResult or int plus_result
 *  2. 두 단어 이상을 이어붙일 때 변수명 지정시 대문자 활용할수 있어요.(낙타 표기법 - 카멜)
 *     ex) int plusResult 
 *  3. 변수명과 메서드명은 첫 글자는 소문자를 사용합니다. 
 ...
 *  5. 이미 사용하고 있는 에약어(키워드 -> if, for, while ...는 변수명으로 사용 x
 ...
 */  	
	...
	public static void main(String[] args) {
		...
		int a = 0;
		if ( a == 0 ) { // 조건이 참인 경우 ...
			System.out.println("if 문 실행됨...");
			}
		
		if ( a == 0 ) { //if의 조건이 참인 경우 실행
			System.out.println("if ~ else문의 if 실행");
