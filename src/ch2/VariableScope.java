...
public class VariableScope {
	...
	public static void main(String[] args) { //메서드영역
		int var1;
		var1 = 100;
		...
		if(true) {                           //첫번째 if 영역
			...
			System.out.println("var1 출력 : "+var2);
			//var1,var2(첫번재 if에서 생성된 변수)를 사용가능
		}
		//var2 변수는 사라짐
...
//			System.out.println("var2 출력 : "+var2);
			System.out.println("var2 출력 : "+var3);
			//var2는 사라져서 참조 못함. var1, var3참조
		}
        //var3 변수 사라짐
