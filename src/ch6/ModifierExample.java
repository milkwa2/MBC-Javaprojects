...
//     			         "\tnum2 = " +sup.num2      // protected이기 때문에 같은 패키지 또는상속
//				         "\tnum3 = " +sup.num3      // default이기 대문에 같은 패키지여야 접근 가능
				         "\tnum4 = " +sup.getNum4() // 패키지 내에 있는 public 메서드를 사용해서
				         );
		System.out.println("\n ******Sub 참조 *****");
		Sub sub = new Sub();
		sub.print();
...
class Sub extends Super { // extends를 사용하여 상속받을 부모를 지정!
	...
	public void print() {
		...
		System.out.println("Super num2 = " + num2);//num2 - protected (같은패키지,상속)
		//num2는같은 패키지인가요? 아니요. 상속관계인가요? 예
