...
public class EncapsulationExample {
    ...
    *    - 이렇게 공개 매서드를 이용하여 데이터를 변경시킬 경우 메서드 내에 데이터 유효성을 검증할 루틴을 
    *    작성할 수 있다.
    *    - 뿐만 아니라 경우 따라 접근 권한을 체크할 수 있는 로직을 포함하면 인가되지 않은 사용자에게 중요한
    *    데이터나 로직을 숨길 수 있다. 
    *    - 꼭 멤버변수(필드)만 private으로 제한하는 것은 아니고, 외부에 공개하고 싶지 않은 메서드들ㄱ도 private
    *    처리할 수 잇습니다.
    * 
    * 
    * 
    */
	...
	public static void main(String[] args) {
		...
		myBirth.setDay(32); // 날짜가 잘 못된 경우... day = 1로설정 저장.
