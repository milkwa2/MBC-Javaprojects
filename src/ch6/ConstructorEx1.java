...
public class ConstructorEx1 {
	// 생성자(Constructor)
    // -> new를 통해서 클래스의 인스턴스를 생성 할 때 호출되는 것
...
class car {
	...
	car(String wheel, int numOfWheel, String brand, String name){
		//this 는 현재 생성된 인스턴스를 의미함.
		
		// this 는 언제 사용할까? 클래스의 변수(필드)와 매개변수의 이름이 같은 경우 
	...
	// 생성자 오버로딩 
	//오버로딩 -> 동일한 생성자, 혹은 메서드의 매게변수를 달리하여 생성자 혹은 메서드를 여러개선언하는것
