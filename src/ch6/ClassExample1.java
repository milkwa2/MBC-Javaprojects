...
public class ClassExample1 {
	...
	public static void main(String[] args) {
		...
		// - 클래스의 메서드는 객체의 행동, 클래스의 변수는 개체의 현재 상태를 나타낸다.
		// - 클래스는 참조형 변수 타입입니다.
		...
		// - public class는 파일의 이름이기 때문에 그 고스 파일 전체의 주제를 알 수 있는 이름을
		//   짓는 것이 좋다.
...
class Student{// 학생이라는 클래스 선언
	...
	public int getTotal() {// 메서드
		...
		// 4. 매개값이 없고, 반환 값이 없는 경우
		
		// 반환 값은 return 카워드를 사용하고 반환 값을 지정
		
		// 메서드 구조
	    // [접근제한자] [반환 타입] [메서드명] (매개 변수들) {
		// 메서드 동작 코드
		// }
